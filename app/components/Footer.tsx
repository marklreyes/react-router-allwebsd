...
export default function Footer() {
  ...
  return (
	<footer className="bg-white dark:bg-darkBg border-t border-gray-200 dark:border-gray-700 py-8" role="contentinfo">
	  <div className="max-w-7xl mx-auto px-4">
		...
		/>
		<div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start text-[#2F241D] dark:text-white">
			...
			<div className="text-center md:text-right">
			  <p>
				<small>
				  ...
				  className="text-secondary dark:text-accent hover:text-primary dark:hover:text-primary hover:underline transition-colors font-semibold"
