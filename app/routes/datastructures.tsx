	...
	return (
		...
		cta={{
			...
			<ul className="list-disc ml-6 space-y-1">
				...
				<li>Curiosity and willingness to learn about data structures through a fun and nostalgic lens.</li>
				<li>
					<strong>OPTIONAL:</strong> Follow along and download the <a
					href="https://github.com/marklreyes/mighty-morphin-data-structures"
					target="_blank"
					...
					onClick={trackEvent("external_resource_click", {
						params: {
						tutorial_name: "Mighty Morphin Data Structures",
